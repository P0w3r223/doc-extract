...
| started | 2026-08-18T16:05:25+00:00 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `kind` | 108 | 84 | 24 | 0 | 0 | 100.0 % | 100.0 % | 77.8 % | 77.8 % |
| `number` | 108 | 0 | 108 | 0 | 0 | 100.0 % | 100.0 % | 0.0 % | 0.0 % |
| `issue_date` | 108 | 0 | 108 | 0 | 0 | 100.0 % | 100.0 % | 0.0 % | 0.0 % |
| `sale_date` | 108 | 0 | 0 | 108 | 0 | 0.0 % | — | — | 0.0 % |
| `currency` | 108 | 96 | 12 | 0 | 0 | 100.0 % | 100.0 % | 88.9 % | 88.9 % |
| `total_gross` | 108 | 0 | 108 | 0 | 0 | 100.0 % | 100.0 % | 0.0 % | 0.0 % |
| `payment_account` | 89 | 0 | 0 | 89 | 0 | 0.0 % | — | — | 0.0 % |
| `seller.name` | 108 | 0 | 108 | 0 | 0 | 100.0 % | 100.0 % | 0.0 % | 0.0 % |
| `seller.nip` | 108 | 0 | 0 | 108 | 0 | 0.0 % | — | — | 0.0 % |
| `seller.address` | 108 | 0 | 0 | 108 | 0 | 0.0 % | — | — | 0.0 % |
| `buyer.name` | 108 | 0 | 108 | 0 | 0 | 100.0 % | 100.0 % | 0.0 % | 0.0 % |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `header` | 737 | 180 | 360 | 197 | 0 | 73.3 % | 100.0 % | 33.3 % | 24.4 % |
| `seller` | 324 | 0 | 108 | 216 | 0 | 33.3 % | 100.0 % | 0.0 % | 0.0 % |
| `buyer` | 324 | 0 | 108 | 216 | 0 | 33.3 % | 100.0 % | 0.0 % | 0.0 % |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `clean` | 366 | 24 | 60 | 282 | 0 | 23.0 % | 100.0 % | 28.6 % | 6.6 % |
| `mixed_rates` | 628 | 24 | 60 | 544 | 0 | 13.4 % | 100.0 % | 28.6 % | 3.8 % |
| `correction` | 354 | 12 | 72 | 270 | 0 | 23.7 % | 100.0 % | 14.3 % | 3.4 % |
| `advance` | 274 | 12 | 72 | 190 | 0 | 30.7 % | 100.0 % | 14.3 % | 4.4 % |
| `reverse_charge` | 394 | 24 | 60 | 310 | 0 | 21.3 % | 100.0 % | 28.6 % | 6.1 % |
| `split_payment` | 468 | 24 | 60 | 384 | 0 | 17.9 % | 100.0 % | 28.6 % | 5.1 % |
| `foreign_currency` | 473 | 12 | 72 | 389 | 0 | 17.8 % | 100.0 % | 14.3 % | 2.5 % |
| `grosz_rounding` | 666 | 24 | 60 | 582 | 0 | 12.6 % | 100.0 % | 28.6 % | 3.6 % |
| `multi_page` | 2443 | 24 | 60 | 2359 | 0 | 3.4 % | 100.0 % | 28.6 % | 1.0 % |

## Per template

| template | support | correct | wrong | missed | spurious | recall | precision | value acc. | accuracy |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `classic` | 1961 | 60 | 192 | 1709 | 0 | 12.9 % | 100.0 % | 23.8 % | 3.1 % |
| `ledger` | 2068 | 60 | 192 | 1816 | 0 | 12.2 % | 100.0 % | 23.8 % | 2.9 % |
| `compact` | 2037 | 60 | 192 | 1785 | 0 | 12.4 % | 100.0 % | 23.8 % | 2.9 % |
